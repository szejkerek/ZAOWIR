...
debugMode = False
squareSizeInMilimeters = 50.00
rows = 7
columns = 10
end = 0
alpha = 0.3
image_dir = "C:\\Projekty\\ZaowrKolos\\kolokwium-zestaw\\left"
...
def UndistortPhoto(mtx, dist):
    img = cv.imread(os.path.join(image_dir, "11.png"))
    h, w = img.shape[:2]
...
if __name__ == "__main__":
    ...
    cv.imwrite('Odpowiedzi/Zad1_4L.png', undistorted_img)
